...
import com.stackroute.moviecruiser.MovieCruiserAuthenticationApplication;
...
@ContextConfiguration(classes=MovieCruiserAuthenticationApplication.class)
...
public class UserControllerTest {
	...
	public void setUp() throws Exception {
		...
		user = new User("john", "jenny", "john", "123456", new Date());
	}
